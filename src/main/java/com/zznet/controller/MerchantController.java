...
public class MerchantController {
    ...
    @RequestMapping("/master/merchantsave")
    public String sysmerchantsave(@RequestParam(value = "mid") int mid,
                                  @RequestParam(value = "merchantname") String merchantname,
                                  @RequestParam(value = "cocid") int cocid,
                                  @RequestParam(value = "province_code") String province_code,
                                  @RequestParam(value = "city_code") String city_code,
                                  @RequestParam(value = "area_code") String area_code,
                                  @RequestParam(value = "memo") String memo,
                                  @RequestParam(value = "headpic") String headpic,
                                  @RequestParam(value = "contact") String contact,
                                  @RequestParam(value = "telno") String telno,
                                  @RequestParam(value = "addr") String addr,
                                  @RequestParam(value = "mstatus") int mstatus) {
        ...
        return "redirect:/master/merchantinfo/" + merchantinfo.getId() + "?result=" + result;
    }

    @RequestMapping("/master/newMerchant")
    public String masternewMerchant(HttpSession session, HttpServletRequest request) {
        ...
        return "redirect:/master/merchantinfo/" + merchantinfo_new.getId();
    }

    @RequestMapping("/master/merchantlist")
    public String mastermerchantlist(HttpServletRequest request,
                                     @RequestParam(value = "mername") String mername,
                                     @RequestParam(value = "curpageno") int curpageno) {
        try {
        ...
        return "master/merchantlist";
    }

    @RequestMapping("/master/merchantinfo/{gid}")
    public String mastermerchantinfo(HttpServletRequest request, @PathVariable int gid) {
        try {
